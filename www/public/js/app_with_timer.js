...
//alert(document.getElementById("passUpCheck").value);
   if(document.getElementById("passUpCheck").value == "no")
   {
...
$.ajax({
                ...
                success: function(response) {
                    ...
                    if (data.status === 'success') {
                       document.getElementById("submitUpdate").value = "Details Updated";
                       document.getElementById("demo").value = "yes";
                        alert(data.message);
